...
public class ViewPagerAdapter_for_Login_Register extends PagerAdapter {

    LayoutInflater layoutInflater;
    private Context context;
    private int img[] = {R.drawable.icons_mascot_51, R.drawable.girl_character};

    public ViewPagerAdapter_for_Login_Register(Context context) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {                                             //ViewGroup:(container) The containing View in which the page will be shown.
        ...
        View view = layoutInflater.inflate(R.layout.image_slider2, null);
        ImageView imageView = (ImageView) view.findViewById(R.id.imageView_girl_boy);
