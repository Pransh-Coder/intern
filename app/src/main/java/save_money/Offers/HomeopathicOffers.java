...
public class HomeopathicOffers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_homeopathic_offers);

        recyclerView = findViewById(R.id.recyclerView_homeopathy);
        ...
        RecyclerAdapterOffers recyclerAdapterOffers = new RecyclerAdapterOffers(HomeopathicOffers.this, giveMeFakeData.giveMeFakeData_homeopathy());
        ...
        backimg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(HomeopathicOffers.this, Health.class);
        ...
        homeImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(HomeopathicOffers.this, HomeActivity.class);
                startActivity(intent);
            }
        });
    }
    public class Autoslide extends TimerTask {              //TimerTask()-A task that can be scheduled for one-time or repeated execution by a Timer.
        ...
        public void run() {
            ...
            HomeopathicOffers.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
